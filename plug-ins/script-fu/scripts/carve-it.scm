...
(define (script-fu-carve-it mask-img mask-drawable bg-layer carve-white)
  (let* (
    ...
    (plug-in-gauss RUN-NONINTERACTIVE img mask-emboss (* 0.32 feather) (* 0.32 feather) 1)
    ...
    (plug-in-gauss RUN-NONINTERACTIVE img cast-shadow-layer (* 0.32 feather) (* 0.32 feather) 1)
